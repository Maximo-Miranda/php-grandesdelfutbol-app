...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Storage — PostgreSQL, 7 days retention
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Ingest — Redis stream to avoid writing to DB on every request
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Recorders — optimized for 12 GB / 6 vCPU server
    |--------------------------------------------------------------------------
    */
    ...
    'recorders' => [
        ...
        Recorders\SlowOutgoingRequests::class => [
            ...
            'ignore' => [],
            'groups' => [
                '#^https://www\.googleapis\.com/.*$#' => 'googleapis.com/*',
                '#^https?://([^/]*).*$#' => '\1',
            ],
        ],
