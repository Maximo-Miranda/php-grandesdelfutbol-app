...
use App\Validation\ValidateCancelHoursBeforeRegistration;
use Illuminate\Validation\Rule;

trait MatchRequestDefaults
{
    protected function matchRules(bool $fieldNullable = false): array
    {
        $club = $this->route('club');
        $fieldRules = array_filter([
            $fieldNullable ? 'nullable' : null,
            'integer',
        ...
        return [
            ...
            'field_id' => array_values($fieldRules),
    ...
    {
        return [
            new ValidateCancelHoursBeforeRegistration,
        ];
    }
