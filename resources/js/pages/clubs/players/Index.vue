...
import { Bell, BellOff, Plus, Search, Shield, UserPlus, UserX } from 'lucide-vue-next';
...
type Props = { club: Club; players: PaginatedPlayers; goalkeepers: Player[] };
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="mx-auto w-full max-w-2xl px-4 py-6">
            ...
            <div v-if="!players?.data?.length && !goalkeepers?.length" class="rounded-lg border border-dashed p-8 text-center">
                        ...
                        >
                            ...
                            <div class="min-w-0 flex-1">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span v-if="isAdmin && !gk.user_id" class="text-amber-500" title="Sin usuario asociado">
                                        <UserX class="size-3.5" />
                                    </span>
                                    <span v-if="isAdmin && gk.user_id && gk.has_push" class="text-green-500/60" title="Notificaciones activas">
                                        <Bell class="size-3" />
                                    </span>
                                    <span v-if="isAdmin && gk.user_id && !gk.has_push" class="text-muted-foreground/40" title="Sin notificaciones">
                                        <BellOff class="size-3" />
                                    </span>
                                </div>
                            </div>
