...
import { Bell, CalendarClock, Clock, Info, MapPin, Pencil, Plus, Repeat, ShieldX, Trophy, WandSparkles } from 'lucide-vue-next';
...
type Props = { club: Club; venues: Venue[]; defaultCancelHoursBefore: number };
